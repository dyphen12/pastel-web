...
def user_signup_ryzen(username, name, lastname, password, email):
    ...
    try:
        ...
        userdf = {'id': ids, 'username': username, 'name': name, 'lastname': lastname, 'password': password, 'email': email, 'type': 'player', 'payment': 0, 'quantums': 0, 'characters': 0, 'characterslimit': 3}
